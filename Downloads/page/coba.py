...
class Treadmill:
    def __init__(self, top=None):
        ...
        self.speed_down.configure(command=coba_support.speed_down)
        ...
        self.start.configure(command=coba_support.start)
        ...
        self.speed_up.configure(command=coba_support.speed_up)
        ...
        self.back.configure(command=coba_support.destroy_window)
        ...
        self.recap.configure(command=coba_support.recap)
